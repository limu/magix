 ...
 * 响应controller没有找到,则由config/init的notFoundPath属性指定404页面controller
 ...
 * 		#!/notfound/ => config/init.notFoundPath
 */
/**
 * MxRouter router构造器,传入config和resource后生成单例
 * @class MxRouter
 * @extend Backbone.Controller
 * @param {Object} options {config:config,resource:resource}
 * @singleton
 */
/**
