...
var EvtInfoCache = Magix.cache(20);
 ...
 *   view写法：
 *
 * 'test<click>': function(e) { * //e.currentId 处理事件的dom节点id(即带有mx-click属性的节点)
     *
 ...
 *
 'test<click,mousedown>': function(e) { * alert(e.type); //可通过type识别是哪种事件类型
     *
 }
 */
...
Mix(Mix(View.prototype, Event), {
    ...
    destroy: function() {
        ...
        me.sign = 0;
        //console.log('core view destroy:',me.id);
    },
    /**
     * 获取渲染当前view的父view
     * @return {View}
