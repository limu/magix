/**********module>>>> backbone**********/
define("backbone", ["jquery", "underscore"], function(require, exports) {
	//     Backbone.js 0.5.3
...
define("underscore",[], function(require, exports, module) {
	...
	(function() {
		...
		_.reduceRight = _.foldr = function(obj, iterator, memo, context) {
			...
			if(nativeReduceRight && obj.reduceRight === nativeReduceRight) {
				if(context)
					iterator = _.bind(iterator, context);
				return memo !==
				void 0 ? obj.reduceRight(iterator, memo) : obj.reduceRight(iterator);
			}
		...
		_.max = function(obj, iterator, context) {
			...
			each(obj, function(value, index, list) {
				var computed = iterator ? iterator.call(context, value, index, list) : value; computed >= result.computed && ( result = {
					value : value,
					computed : computed
				});
			});
		...
		_.sortedIndex = function(array, obj, iterator) {
			...
			while(low < high) {
				var mid = (low + high) >> 1; iterator(array[mid]) < iterator(obj) ? low = mid + 1 : high = mid;
			}
			return low;
		};
