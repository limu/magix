define("magix/ajax",["magix/impls/ajax","magix/base"],function(a){var c=a("magix/impls/ajax"),e=a("magix/base");return e.implement({defaultOptions:{dataType:"html",success:function(){},failure:function(){}},send:e.unimpl,processOptions:function(b){b||(b={});for(var d in this.defaultOptions)b[d]||(b[d]=this.defaultOptions[d]);return b},getTemplate:function(b,d,a){var g=this,c;if(!g.$cache)g.$cache={};(c=g.$cache[b])?c.succ&&e.isFunction(d)?d(c.content):!c.succ&&e.isFunction(a)&&a(c.content):g.send({url:b,
dataType:"html",success:function(a){g.$cache[b]={succ:!0,content:a};e.isFunction(d)&&d(a)},failure:function(d){g.$cache[b]={content:d};e.isFunction(a)&&a(d)}})}},c)});
define("magix/base",["magix/impls/base"],function(a){var a=a("magix/impls/base"),c={mix:function(e,b,d,a){if(!b||!e)return e;void 0===d&&(d=!0);var g,c,h;if(a&&(h=a.length))for(g=0;g<h;g++){if(c=a[g],c in b&&(d||!(c in e)))e[c]=b[c]}else for(c in b)if(d||!(c in e))e[c]=b[c];return e},include:function(a){var a=Magix.config.magixHome+"../"+a+".js?r="+Math.random(),b=new (window.ActiveXObject||XMLHttpRequest)("Microsoft.XMLHTTP");b.open("GET",a,!1);b.send(null);return b.responseText},unimpl:function(){throw Error("unimplement method");
}};c.mix(c,{isFunction:c.unimpl,isArray:c.unimpl,isString:c.unimpl,isPlainObject:c.unimpl,requireAsync:c.unimpl,Events:c.unimpl,_idCounter:0,uniqueId:function(a){var b=this._idCounter++;return a?a+b:b},extend:function(a,b,d,m){if(!b||!a)return a;var g=Object.prototype,c=b.prototype,h=function(b){function d(){}d.prototype=b;return new d}(c);a.prototype=h;h.constructor=a;a.superclass=c;if(b!==Object&&c.constructor===g.constructor)c.constructor=b;d&&this.mix(h,d);m&&this.mix(a,m);return a},param:function(a){var b=
...
define("magix/impls/vframe",["magix/base"],function(a){var a=a("magix/base"),c=function(){};a.mix(c,{tagName:"vframe"});a.mix(c.prototype,{getChildVframeNodes:function(){var a=document.getElementById(this.id).getElementsByTagName("vframe"),b,d=[];for(b=0;b<a.length;b++)d.push(this._idIt(a[b]));return d},createFrame:function(){return document.createElement(c.tagName)}});return c});
...
define("magix/mu",["mustache"],function(a){function c(b){b=b.split("==");return function(){for(var a=b[0].split("."),c=b[1],e=a.length-1;-1<e;e--){var h=a.slice(e),k=this;try{for(var n=0;n<h.length-1;n++)k=k[h[n]];if(h[h.length-1]in k){if(k[h[h.length-1]].toString()===c)return!0;break}}catch(i){}}return!1}}function e(b,a){var c,f;for(c in b)if(f=b[c],f instanceof Array)for(var h=0;h<f.length;h++){if(o=f[h],"object"==typeof o)0===h?o.__first__=!0:h==f.length-1?o.__last__=!0:o.__mid__=!0,o.__index__=
h}else"object"==typeof f&&5>a&&e(f,a+1)}var b=a("mustache");return{to_html:function(a,m){"object"==typeof m&&e(m,0);var g=m,f;f=/\{{2,3}[\^#]?if\((.*?)\)\}{2,3}?/i;var h=a.match(/\{{2,3}[\^#]?if\((.*?)\)\}{2,3}?/ig),k=[];if(h)for(var n=0;n<h.length;n++)k.push(h[n].match(f)[1]);f=k;h="";for(k=0;k<f.length;k++)h="if("+f[k]+")",g[h]||(g[h]=c(f[k]));return b.to_html.apply(this,arguments)}}});if(!window.console)window.console={log:function(){},dir:function(){},warn:function(){},error:function(){}};
...
{},a=this._locator;e.mix(b,a.state.paraObj);e.mix(b,{referrer:a.state.referrer,query:a.state.query,pathname:a.state.pathName,postdata:a.state.postData||null});var c={},g,f=a.search.paraObj;c["sch:pathname"]=a.search.pathName;c["sch:query"]=a.search.query;for(g in f)c["sch:"+g]=f[g];e.mix(b,c);return b}});return e.implement(a,c)});
...
d._changeChain(a,this)});this.init&&this.init();this.getTemplate(function(a){d.template=a;!1!==d.render()&&d.trigger("rendered")})},_queryModelChange:function(a){this._changeChain(this.queryModelChange(a),a)},_changeChain:function(a,d){var c=[],g;g=this.getVOMObject().getElementById(this.vcid);if(!1!==a){!0===a||void 0===a?c=g.childNodes:e.isArray(a)&&(c=a);for(g=0;g<c.length;g++)c[g].view&&c[g].view._queryModelChange(d)}},destory:function(){this.destroy()},destroy:function(){var a,d,c=this.getVOMObject();
a=this.getDestoryQueue();for(d=a.length-1;0<d;d--)a[d].removeNode();c.getElementById(this.vcid).unmountView();this.dispose()},getDestoryQueue:function(){function a(c){var e;d.push(c);for(e=0;e<c.childNodes.length;e++)a(c.childNodes[e])}var d=[],c=this.getVOMObject().getElementById(this.vcid);a(c);return d},setData:function(a){this.data=a;for(var d in a)a[d].toJSON&&(a[d]=a[d].toJSON());a.query=this.queryModel.toJSON();this.setRenderer()},setRenderer:function(){var a=this,d=this.renderer,c,e;if(d)for(c in d)for(e in d[c])(function(){var f=
c,h=e,k=d[f][h];a.data[f+"_"+h]=function(){return k.call(this,a,f)}})()},delegateEvents:function(){var a=this.events,d=this.eventsLevel,c=this.getVOMObject(),e=document.getElementById(this.options.vcid),f;for(f in a)(function(){var a=f,b="mx"+a;e["on"+a]=function(f){var f=f||window.event,i=f.target||f.srcElement;if(3===i.nodeType)i=i.parentNode;var l=i.getAttribute(b);if(d)var j=d[a];if(!l&&j)if(!isNaN(j)&&j)for(;j&&i!=e;){i=i.parentNode;if(l=i.getAttribute(b))break;j--}else if(j.split(".")[1])for(j=
j.split(".")[1];i!=e;){if(i=i.parentNode,0<=i.className.indexOf(j)){l=i.getAttribute(b);break}}else{if(j.split("#")[1])for(j=j.split("#")[1];i!=e;)if(i=i.parentNode,i.id==j){l=i.getAttribute(b);break}}else if(!l)i=i.parentNode,l=i.getAttribute(b);if(l)for(var j=l.split("|"),r,p=c.getElementById(this.id).view,s=0;s<j.length;s++){l=j[s].split(":");r=l.shift();var q=l[l.length-1],t=!1;if("_halt_"==q||"_preventDefault_"==q)f.preventDefault?f.preventDefault():f.returnValue=!1,t=!0;if("_halt_"==q||"_stop_"==
q)f.stopPropagation?f.stopPropagation():f.cancelBubble=!0,t=!0;t&&l.pop();if(p.events&&p.events[a]&&p.events[a][r])p.events[a][r](p,p.idIt(i),l)}}})()},render:function(){if(this.preventRender)return this.rendered=!0;var a=document.getElementById(this.vcid),d=this.getTemplateObject();a.innerHTML=d.toHTML({template:this.template,data:{data:this.data,queryModel:this.queryModel.toJSON()}});this.rendered=!0},getTemplate:function(a,d){if(this.preventRender)a();else{var c=Magix.config.appHome+this.viewName.split("app")[1];
this.getAjaxObject().getTemplate(d?c+".name.html":c+".html",function(c){a(c)},function(c){a(c)})}},idIt:function(a){var c="";if(!a.id)a.id=e.uniqueId("mxevt-");return c=a.id}});return e.implement(a,c)});
define("magix/vom",["magix/impls/vom","magix/base","magix/vframe"],function(a){var c=a("magix/impls/vom"),e=a("magix/base"),b=a("magix/vframe"),a={};e.mix(a,{_idMap:{},root:null,setRootVframe:e.unimpl,init:function(){this.setRootVframe();return this},push:function(a){this._idMap[a.id]=a},pop:function(a){delete this._idMap[a.id]},createElement:function(a,c){e.isString(a)&&(a=document.getElementById(a));var g=new b(a,c);this.push(g);return g},getElementById:function(a){return this._idMap[a]||null}});
