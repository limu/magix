...
define("magix/impls/model",["backbone"],function(a){a=a("backbone").Model;a.prototype.removeAttr=function(a){this.unset(a,{slient:!0})};a.prototype.load=function(){this.fetch.apply(this,arguments)};return a});
...
this.queryModel.set(this.query)},_fixQueryModel:function(a){if(this.queryModel){var c,b=this.queryModel.toJSON();for(c in b)c in a||this.queryModel.unset(c,{silent:!0})}},navigateTo:function(a){var a=b.unParam(a),c=g.clone(this.state.paraObj);delete c.referrer;delete c.pathname;delete c.query;delete c.postdata;a=g.extend(c,a);this.goTo(this.state.pathName+"/"+b.param(a))}}});
...
Magix={init:function(a){this.config=a;this.setEnv();this.bootstrap()},setEnv:function(){var a={magix:this.config.magixHome,app:this.config.appHome};a.magix&&!/\//.test(a.magix)&&(a.magix+="/");a.app&&!/\//.test(a.app)&&(a.app+="/");if(this.config.debug)this.dev=!0;this.dev?seajs.config({debug:2}):delete a.magix;seajs.config({alias:a});MxHistory&&MxHistory.init&&MxHistory.init(this.config)},bootstrap:function(){var a=this;seajs.use(["magix/router"],function(b){b.init(a.config)})},implementBy:"seajs-backbone-jquery",
version:"0.3.0",dev:""};define("magix/model",["magix/impls/model","magix/base"],function(a){var b=a("magix/impls/model"),a=a("magix/base");eval(a.include("tmpls/model"));return a.implement(void 0,b)});
