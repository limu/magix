define("magix/ajax",["magix/impls/ajax","magix/base"],function(d){var e=d("magix/impls/ajax"),b=d("magix/base");return b.implement({defaultOptions:{dataType:"html",success:function(){},failure:function(){}},send:b.unimpl,processOptions:function(a){a||(a={});for(var c in this.defaultOptions)a[c]||(a[c]=this.defaultOptions[c]);return a},getTemplate:function(a,c,k){var f=this,d;if(!f.$cache)f.$cache={};(d=f.$cache[a])?d.succ&&b.isFunction(c)?c(d.content):!d.succ&&b.isFunction(k)&&k(d.content):f.send({url:a,
dataType:"html",success:function(d){f.$cache[a]={succ:!0,content:d};b.isFunction(c)&&c(d)},failure:function(c){f.$cache[a]={content:c};b.isFunction(k)&&k(c)}})}},e)});
define("magix/base",["magix/impls/base"],function(d){var d=d("magix/impls/base"),e={mix:function(b,a,c,d){if(!a||!b)return b;void 0===c&&(c=!0);var f,e,i;if(d&&(i=d.length))for(f=0;f<i;f++){if(e=d[f],e in a&&(c||!(e in b)))b[e]=a[e]}else for(e in a)if(c||!(e in b))b[e]=a[e];return b},include:function(b){var b=Magix.config.magixHome+"../"+b+".js?r="+Math.random(),a=new (window.ActiveXObject||XMLHttpRequest)("Microsoft.XMLHTTP");a.open("GET",b,!1);a.send(null);return a.responseText},unimpl:function(){throw Error("unimplement method");
}};e.mix(e,{isFunction:e.unimpl,isArray:e.unimpl,isString:e.unimpl,isPlainObject:e.unimpl,requireAsync:e.unimpl,Events:e.unimpl,_idCounter:0,uniqueId:function(b){var a=this._idCounter++;return b?b+a:a},extend:function(b,a,c,d){if(!a||!b)return b;var f=Object.prototype,e=a.prototype,i=function(a){function c(){}c.prototype=a;return new c}(e);b.prototype=i;i.constructor=b;b.superclass=e;if(a!==Object&&e.constructor===f.constructor)e.constructor=a;c&&this.mix(i,c);d&&this.mix(b,d);return b},param:function(b){var a=
...
unbind:function(b,a){var c;if(b){if(c=this._callbacks)if(a){c=c[b];if(!c)return this;for(var d=0,f=c.length;d<f;d++)if(c[d]&&a===c[d][0]){c[d]=null;break}}else c[b]=[]}else this._callbacks={};return this},trigger:function(b){var a,c,d,f,e=2;if(!(c=this._callbacks))return this;for(;e--;)if(a=e?b:"all",a=c[a])for(var i=0,l=a.length;i<l;i++)(d=a[i])?(f=e?Array.prototype.slice.call(arguments,1):arguments,d[0].apply(d[1]||this,f)):(a.splice(i,1),i--,l--);return this}}}});
...
define("magix/impls/router",["magix/base","magix/model","magix/vom","app/config/ini"],function(d){var e=d("magix/base"),b=d("magix/model"),a=d("magix/vom"),c=d("app/config/ini"),k;KISSY.use("mvc",function(a,c){k=c});return{getAppConfig:function(){var a=c.pathViewMap;if(c.defaultViewName)for(var b in a)if(!a[b])a[b]=c.defaultViewName;return c},setStateListener:function(){var a=this;(new k.Router).addRoutes({"*hash":function(c){KISSY.log(c.hash);a.route(c.hash)}});k.Router.start({triggerRoute:1,urlRoot:location.href.split("#")[0].split("index.html")[0]})},
...
define("magix/impls/vframe",["magix/base"],function(d){var d=d("magix/base"),e=function(){};d.mix(e,{tagName:"vframe"});d.mix(e.prototype,{getChildVframeNodes:function(){var b=document.getElementById(this.id).getElementsByTagName("vframe"),a,c=[];for(a=0;a<b.length;a++)c.push(this._idIt(b[a]));return c},createFrame:function(){return document.createElement(e.tagName)}});return e});
define("magix/impls/view",["magix/vom","magix/ajax","magix/template","magix/base"],function(d){var e=d("magix/vom"),b=d("magix/base"),a=d("magix/ajax"),c=d("magix/template"),d=KISSY,k;d.use("mvc",function(a,c){k=c});var f=function(){f.superclass.constructor.apply(this,arguments)};d.extend(f,k.View,{initial:function(){this.delegateEvents()},getVOMObject:function(){return e},getAjaxObject:function(){return a},getTemplateObject:function(){return c},dispose:function(){f.superclass.destroy.apply(this,
arguments)}});d.mix(f.prototype,b.Events);var m=f.prototype.fire;f.prototype.fire=function(a,c){m(a,c);this.trigger(a,c)};return f});define("magix/impls/vom",["magix/base"],function(d){d("magix/base");return{setRootVframe:function(){var d=null;if("vf-root"==document.body.id)d=document.body;var b=this.createElement(d,"vf-root");d||document.body.insertBefore(b.getOnce(),document.body.firstChild);this.root=b}}});
...
{},c=this._locator;b.mix(a,c.state.paraObj);b.mix(a,{referrer:c.state.referrer,query:c.state.query,pathname:c.state.pathName,postdata:c.state.postData||null});var d={},e,m=c.search.paraObj;d["sch:pathname"]=c.search.pathName;d["sch:query"]=c.search.query;for(e in m)d["sch:"+e]=m[e];b.mix(a,d);return a}});return b.implement(d,e)});
...
b,i=d,l=c[e][i];a.data[e+"_"+i]=function(){return l.call(this,a,e)}})()},delegateEvents:function(){var a=this.events,c=this.eventsLevel,b=this.getVOMObject(),d=document.getElementById(this.options.vcid),e;for(e in a)(function(){var a=e,l="mx"+a;d["on"+a]=function(e){var e=e||window.event,g=e.target||e.srcElement;if(3===g.nodeType)g=g.parentNode;var j=g.getAttribute(l);if(c)var h=c[a];if(!j&&h)if(!isNaN(h)&&h)for(;h&&g!=d;){g=g.parentNode;if(j=g.getAttribute(l))break;h--}else if(h.split(".")[1])for(h=
h.split(".")[1];g!=d;){if(g=g.parentNode,0<=g.className.indexOf(h)){j=g.getAttribute(l);break}}else{if(h.split("#")[1])for(h=h.split("#")[1];g!=d;)if(g=g.parentNode,g.id==h){j=g.getAttribute(l);break}}else if(!j)g=g.parentNode,j=g.getAttribute(l);if(j)for(var h=j.split("|"),m,n=b.getElementById(this.id).view,p=0;p<h.length;p++){j=h[p].split(":");m=j.shift();var o=j[j.length-1],q=!1;if("_halt_"==o||"_preventDefault_"==o)e.preventDefault?e.preventDefault():e.returnValue=!1,q=!0;if("_halt_"==o||"_stop_"==
o)e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,q=!0;q&&j.pop();if(n.events&&n.events[a]&&n.events[a][m])n.events[a][m](n,n.idIt(g),j)}}})()},render:function(){if(this.preventRender)return this.rendered=!0;var a=document.getElementById(this.vcid),c=this.getTemplateObject();a.innerHTML=c.toHTML({template:this.template,data:{data:this.data,queryModel:this.queryModel.toJSON()}});this.rendered=!0},getTemplate:function(a,c){if(this.preventRender)a();else{var b=Magix.config.appHome+this.viewName.split("app")[1];
this.getAjaxObject().getTemplate(c?b+".name.html":b+".html",function(b){a(b)},function(b){a(b)})}},idIt:function(a){var c="";if(!a.id)a.id=b.uniqueId("mxevt-");return c=a.id}});return b.implement(d,e)});
