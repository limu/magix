...
define("magix/impls/model",["magix/base"],function(a){var b=KISSY,a=a("magix/base"),d;b.use("mvc",function(a,b){d=b.Model});b.mix(d.prototype,a.Events);var h=d.prototype.fire,c=/^after(.+?)Change$/;d.prototype.fire=function(a,b){h(a,b);"*"==a.charAt(0)&&(a=a.substring(1).replace(/[A-Z]/,function(a){return a.toLowerCase()}));this.trigger(a,b);if(c.test(a)){var e=a.replace(c,function(a,b){return b.toLowerCase()});if(!this.__propsValueChanged)this.__propsValueChanged={};this.__propsValueChanged[e]=!0}};
d.prototype.hasChanged=function(a){var b=this.__propsValueChanged;return b?b[a]:!1};d.prototype.clear=function(){var a=this.toJSON(),b;for(b in a)this.removeAttr(b)};return d});
