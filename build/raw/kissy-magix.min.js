...
d.init()},0);this.preventRender||this.getTemplate(function(a){d.template=a;setTimeout(function(){if(d.exist)!1!==d.render()&&!d.__isStartMountSubs&&d.trigger("rendered"),d.__rendered=!0,d.trigger("renderComplete",!0)},0)})},_queryModelChange:function(a){try{if(this.hashHasChanged())var d=this.queryModelChange(a)}catch(b){}this.__isStartMountSubs&&(d=!1);this._changeChain(d,a)},_changeChain:function(a,d){var c=[],e;e=this.getVOMObject().getElementById(this.vcid);if(!1!==a){!0===a||void 0===a?c=e.childNodes:
b.isArray(a)&&(c=a);for(e=0;e<c.length;e++)c[e].view&&c[e].view._queryModelChange(d)}},destory:function(){this.destroy()},destroy:function(){if(this.events){var a=document.getElementById(this.vcid),d;for(d in this.events)a["on"+d]=null}this.dispose()},setData:function(a){this.data=a;for(var d in a)a[d]&&a[d].toJSON&&(a[d]=a[d].toJSON());a.query=this.queryModel.toJSON();this.setRenderer()},setRenderer:function(){var a=this,d=this.renderer,b,c;if(d)for(b in d)for(c in d[b])(function(){var e=b,f=c,i=
d[e][f];a.data[e+"_"+f]=function(){return i.call(this,a,e)}})()},getEventInfo:function(a,d){for(var b=a.target||a.srcElement,c=a.type,e="mx"+c,f=this.eventsLevel;3===b.nodeType;)b=b.parentNode;var i=b.getAttribute(e);if(f)var l=f[c];if(!i&&l)if(!isNaN(l)&&l)for(;l&&b!=d;){b=b.parentNode;if(i=b.getAttribute(e))break;l--}else if(l.split(".")[1])for(l=l.split(".")[1];b!=d;){if(b=b.parentNode,0<=b.className.indexOf(l)){i=b.getAttribute(e);break}}else{if(l.split("#")[1])for(l=l.split("#")[1];b!=d;)if(b=
b.parentNode,b.id==l){i=b.getAttribute(e);break}}else if(!i)b=b.parentNode,i=b.getAttribute(e);return{info:i,target:b}},processEvent:function(a,b){var c=a||window.event,e=this.getEventInfo(c,b||document.getElementById(this.vcid)),f=c.type,j={},i=e.target,e=e.info,j={target:i,originEvent:c};if(e)for(var e=e.split("|"),l,m,p=0;p<e.length;p++){l=e[p].split(":");m=l.shift();var n=l[l.length-1],q=!1;if("_halt_"==n||"_preventDefault_"==n)c.preventDefault?c.preventDefault():c.returnValue=!1,q=j.isPreventDefault=
!0;if("_halt_"==n||"_stop_"==n)c.stopPropagation?c.stopPropagation():c.cancelBubble=!0,q=j.isStopPropagation=!0;q&&l.pop();this.trigger("beforeEventCall",j);if(this.events&&this.events[f]&&this.events[f][m])this.events[f][m](this,this.idIt(i),l,c)}this.trigger("delegateEventsFire",j)},delegateEvents:function(){var a=this,b=document.getElementById(a.vcid),c=this.events,e;for(e in c)b["on"+e]=function(c){a.processEvent(c,b)}},setViewHTML:function(a){var b=this;return b.exist?(b.trigger("beforeRebuild",
!0),b.trigger("prerender"),document.getElementById(b.vcid).innerHTML=a,b.trigger("rendered"),b.__isStartMountSubs=!0,setTimeout(function(){delete b.__isStartMountSubs},0),!0):!1},render:function(){},getTemplate:function(a,b){if(this.template)a(this.template);else{var c=Magix.config.appHome,c=/\/app\/$/.test(c)?c+this.viewName.split("app")[1]:c+this.viewName,c=(b?c+".name.html":c+".html").replace(/([^:\/])\/+/g,"$1/"),e=this.getAjaxObject();if(Magix.dev||!Magix.config.release)c+="?t="+(new Date).getTime();
e.getTemplate(c,function(b){a(b)},function(b){a(b)},this.viewName)}},idIt:function(a){var d="";if(!a.id)a.id=b.uniqueId("mxevt-");return d=a.id},receiveMessage:function(){},hashChange:function(){},_hashChange:function(a){!this.__isStartMountSubs&&this.hashHasChanged()&&(this.hashChange(a),this.observeHash())},_receiveMessage:function(a){var b=this;try{b.exist&&b.__rendered?b.receiveMessage(a):(b.unbind("renderComplete"),b.bind("renderComplete",function(){b.receiveMessage(a)}))}catch(c){}},postMessageTo:function(a,
c){var e=this.getVOMObject();b.isArray(a)||(a=[a]);for(var f=0;f<a.length;f++){var g=e.get(a[f]);g&&g.postMessage(c,this)}},observeHash:function(a,c){if(a){b.isArray(a)||(a=[a]);this.$observeHashKeys=a;this.$observeHashCache={};for(var e=0;e<a.length;e++)this.$observeHashCache[a[e]]=this.queryModel.get(a[e])}else c||this.observeHash(this.$observeHashKeys,!0)},hashHasChanged:function(a){var b=this.$observeHashCache,c=this.$realUsingCache,e;if(!a)a=this.$observeHashKeys;if(a){if(b){e=!1;for(var f=0,
j,i;f<a.length&&!(j=a[f],b.hasOwnProperty(j)&&(i=this.queryModel.get(j),(e=b[j]!=i)&&c&&c.hasOwnProperty(j)&&(e=c[j]!=i),e));f++);return e}for(f=0;f<a.length;f++)if(this.queryModel.hasChanged(a[f]))return!0;return!1}return!0},hashHasChangedExcept:function(a){var b=[],c={},e=this.$observeHashKeys;if(a&&e){f.isArray(a)||(a=[a]);for(var g=0;g<a.length;g++)c[a[g]]=1;for(g=0;g<e.length;g++)c[e[g]]||b.push(e[g])}else b=e;return this.hashHasChanged(b)},hashRealUsing:function(a){if(a){if(!this.$realUsingCache)this.$realUsingCache=
{};for(var b in a)this.$realUsingCache[b]=a[b]}}});return b.implement(e,c)},{requires:["magix/impls/view","magix/base"]});
