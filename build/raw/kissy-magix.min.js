...
KISSY.add("magix/base",function(f,c){var b={mix:function(e,a,d,h){if(!a||!e)return e;void 0===d&&(d=!0);var b,c,f;if(h&&(f=h.length))for(b=0;b<f;b++){if(c=h[b],c in a&&(d||!(c in e)))e[c]=a[c]}else for(c in a)if(d||!(c in e))e[c]=a[c];return e},include:function(b){var b=Magix.config.magixHome+"../"+b+".js?r="+Math.random(),a=new (window.ActiveXObject||XMLHttpRequest)("Microsoft.XMLHTTP");a.open("GET",b,!1);a.send(null);return a.responseText},unimpl:function(){throw Error("unimplement method");}};
b.mix(b,{isFunction:b.unimpl,isArray:b.unimpl,isString:b.unimpl,isPlainObject:b.unimpl,requireAsync:b.unimpl,Events:b.unimpl,_idCounter:0,uniqueId:function(b){var a=this._idCounter++;return b?b+a:a},extend:function(b,a,d,h){if(!a||!b)return b;var c=Object.prototype,g=a.prototype,f=function(a){function d(){}d.prototype=a;return new d}(g);b.prototype=f;f.constructor=b;b.superclass=g;if(a!==Object&&g.constructor===c.constructor)g.constructor=a;d&&this.mix(f,d);h&&this.mix(b,h);return b},param:function(b){var a=
...
0,h=a.length;d<h;d++)if(a[d]&&c===a[d][0]){a[d]=null;break}}else a[b]=[]}else this._callbacks={};return this},trigger:function(b,c){var a,d,h,k,g=2;if(!(d=this._callbacks))return this;for(;g--;)if(a=g?b:"all",a=d[a])for(var f=0,i=a.length;f<i;f++)(h=a[f])?(k=g?Array.prototype.slice.call(arguments,1):arguments,h[0].apply(h[1]||this,k)):(a.splice(f,1),f--,i--);!0==c&&delete d[b];return this}}}},{requires:["ajax"]});
...
changeQueryModel:function(){this._fixQueryModel(this.query);this.queryModel.set(this.query)},_fixQueryModel:function(a){if(this.queryModel){var d,b=this.queryModel.toJSON();for(d in b)d in a||this.queryModel.unset(d,{silent:!0})}},navigateTo:function(a){var a=c.unParam(a),d=f.clone(this.state.paraObj);delete d.referrer;delete d.pathname;delete d.query;delete d.postdata;var a=c.mix(d,a),b;for(b in a)a[b]||delete a[b];this.goTo(this.state.pathName+"/"+c.param(a))}}},{requires:["magix/base","magix/model",
"magix/vom","mvc","app/config/ini"]});KISSY.add("magix/impls/template",function(f,c){return{toHTML:function(b){b=this.processOptions(b);return c.toHTML(b.template,b.data)}}},{requires:["magix/tmpl"]});
...
this.queryModel)}this.postData=null},_spreadLocator:function(){var c={},a=this._locator;b.mix(c,a.state.paraObj);b.mix(c,{referrer:a.state.referrer,query:a.state.query,pathname:a.state.pathName,postdata:a.state.postData||null});var d={},h,f=a.search.paraObj;d["sch:pathname"]=a.search.pathName;d["sch:query"]=a.search.query;for(h in f)d["sch:"+h]=f[h];b.mix(c,d);return c}});b.mix(f,c);return f},{requires:["magix/impls/router","magix/base"]});
...
";"+b+".push('")+"');return "+b+".join('')",c[a]=e);var g=[b],l=[[]],i;if(h)for(i in h)g.push(i.replace(/[:+\-*\/&^%#@!~]/g,"$")),l.push(h[i]);i=g.join("_")+"_"+e;if(!f[i])try{f[i]=new Function(g,e)}catch(j){return j.message}try{e=f[i].apply(h,l)}catch(m){e=m.message}return e}return a};return{toHTML:function(d,b){var c=d.match(e);if(c)var d=d.replace(e,function(){return'<script type="text/notRenderTemplate"><\/script>'}),d=a(d,b),f=0,d=d.replace(e,function(){return c[f++]});else d=a(d,b);return d}}});
...
(a=document.getElementById(this.linkid),a.parentNode.removeChild(a)));this.parentNode._removeChild(this)},_removeChild:function(a){var d,b,c=[];for(d=0;d<this.childNodes.length;d++)b=this.childNodes[d],b==a?this._popFromVOM(b):c.push(b);this.childNodes=c},_popFromVOM:function(a){this.getVOMObject().pop(a);a.exist=!1},postMessage:function(a,d){var b=this;if(b.exist)a||(a={}),a.from=d,b.__viewLoaded?b.view._receiveMessage(a):(b.unbind("viewLoaded"),b.bind("viewLoaded",function(){b.view._receiveMessage(a)}))}});
return b.implement(e,c).init()},{requires:["magix/impls/vframe","magix/base"]});
...
this,d=this.renderer,b,c;if(d)for(b in d)for(c in d[b])(function(){var e=b,f=c,i=d[e][f];a.data[e+"_"+f]=function(){return i.call(this,a,e)}})()},getEventInfo:function(a,d){for(var b=a.target||a.srcElement,c=a.type,e="mx"+c,f=this.eventsLevel;3===b.nodeType;)b=b.parentNode;var i=b.getAttribute(e);if(f)var j=f[c];if(!i&&j)if(!isNaN(j)&&j)for(;j&&b!=d;){b=b.parentNode;if(i=b.getAttribute(e))break;j--}else if(j.split(".")[1])for(j=j.split(".")[1];b!=d;){if(b=b.parentNode,0<=b.className.indexOf(j)){i=
b.getAttribute(e);break}}else{if(j.split("#")[1])for(j=j.split("#")[1];b!=d;)if(b=b.parentNode,b.id==j){i=b.getAttribute(e);break}}else if(!i)b=b.parentNode,i=b.getAttribute(e);return{info:i,target:b}},processEvent:function(a,b){var c=a||window.event,e=this.getEventInfo(c,b||document.getElementById(this.vcid)),f=c.type,l={},i=e.target,e=e.info,l={target:i,originEvent:c};if(e)for(var e=e.split("|"),j,m,p=0;p<e.length;p++){j=e[p].split(":");m=j.shift();var n=j[j.length-1],q=!1;if("_halt_"==n||"_preventDefault_"==
n)c.preventDefault?c.preventDefault():c.returnValue=!1,q=l.isPreventDefault=!0;if("_halt_"==n||"_stop_"==n)c.stopPropagation?c.stopPropagation():c.cancelBubble=!0,q=l.isStopPropagation=!0;q&&j.pop();this.trigger("beforeEventCall",l);if(this.events&&this.events[f]&&this.events[f][m])this.events[f][m](this,this.idIt(i),j,c)}this.trigger("delegateEventsFire",l)},delegateEvents:function(){var a=this,b=document.getElementById(a.vcid),c=this.events,e;for(e in c)b["on"+e]=function(c){a.processEvent(c,b)}},
