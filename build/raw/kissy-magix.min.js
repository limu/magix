...
mountView:function(a,c){if(a){this.unmountView();var b=this,e=this.getRouterObject(),c=c||{};if(!c.queryModel)c.queryModel=e.queryModel;d.requireAsync(a,function(d){if(b.exist)c.vcid=b.id,c.viewName=a,b.view=new d(c),b.__viewLoaded=!0,b.trigger("viewLoaded",!0),b.handelMounted()})}},unmountView:function(){if(this.view&&this.mounted)this.destroySubFrames(),this.view.beforeDestroy(),this.view.trigger("unload",!0),this.view.trigger("beforeRebuild",!0),this.view.destroy(),this.view.afterDestroy(),document.getElementById(this.view.vcid).innerHTML=
"",this.mounted=!1,this.view=null},destroySubFrames:function(){function a(b){c.push(b);for(var d=0;d<b.childNodes.length;d++)a(b.childNodes[d])}var c=[],b=this.getVOMObject().getElementById(this.id);a(b);for(b=c.length-1;0<b;b--)c[b].removeNode()},removeNode:function(){this.mounted&&this.unmountView();this.trigger("unload");var a=document.getElementById(this.id);a&&(a.parentNode.removeChild(a),this.linkid&&(a=document.getElementById(this.linkid),a.parentNode.removeChild(a)));this.parentNode._removeChild(this)},
_removeChild:function(a){var c,b,d=[];for(c=0;c<this.childNodes.length;c++)b=this.childNodes[c],b==a?this._popFromVOM(b):d.push(b);this.childNodes=d},_popFromVOM:function(a){this.getVOMObject().pop(a);a.exist=!1},postMessage:function(a,b){var d=this;if(d.exist)a||(a={}),a.from=b,d.__viewLoaded?d.view._receiveMessage(a):(d.unbind("viewLoaded"),d.bind("viewLoaded",function(){d.view._receiveMessage(a)}))}});return d.implement(b,e).init()},{requires:["magix/impls/vframe","magix/base"]});
